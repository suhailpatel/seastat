...
| ------------- | ------------- | ---- |
| `seastat_table_coordinator_read_latency` | Read Latency for queries to the table which this node coordinates | Summary |
| `seastat_table_coordinator_write_latency` | Write Latency for queries to the table which this node coordinates | Summary |
| `seastat_table_coordinator_range_scan_latency` | Range Scan Latency for queries to the table which this node coordinates | Summary |
| `seastat_table_read_latency` | Read Latency for queries which this node is involved in | Summary |
| `seastat_table_write_latency` | Write Latency for queries which this node is involved in | Summary |
| `seastat_table_range_scan_latency` | Range Scan Latency for queries which this node is involved in | Summary |
